...
//History: Version 2.0 March 12 2026
...
//It exports the main functions to be used in app.js.
      ...
      //Main function
      //Generates and returns the passphrase with the help of helper functions. 
      ...
      export function generateAcronym(wordsTrans, numTt, initLt,){
        ...
        function matchInit(number,index){
          ...
          if (word.charAt(0) != initArr[index]){
              console.log("Word "+word+" does not start with "+initArr[index]+". Rolling again.");
